...
DEEPSEEK_BROWSER_RUNTIME_SOURCE="$source_dir" DEEPSEEK_BROWSER_RUNTIME_DIR="$target_dir" "$root/scripts/prepare-browser-runtime.sh"
...
HOME="$cache_home" DEEPSEEK_BROWSER_RUNTIME_DIR="$cache_target" "$root/scripts/prepare-browser-runtime.sh"
